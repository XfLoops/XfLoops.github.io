    ...
    $.fn.gammacalendar = function(data, options) {
        ...
        for ( var i = 0; i < options.weeks; i++) {
            ...
            for ( var j = 0; j < 7; j++) {
                ...
                var showDate = currentDay.toString().substr(4,12);
                ...
                if(post == null){
                    activityStatus = 'No activity on ' + showDate;
                    tip = $('<div class="tip no-activity-tip">'+ activityStatus +'</div>');
                    tringle = $('<span class="tringle no-activity-tri"/>');
                    day = $('<div class="day" style="background-color: ' + backgroundColor + ';" />');
                    ...
                    //@TODO 丰富tip的内容,像stackoverflow的弹出框一样 Done
                    //@TODO 初次浏览时最新的文章的tooltip显示出来 (弃用)

                    activityStatus =
                        '<div class="tip-header">Published on ' + showDate + '<span><a href="#">contact</a></span><span>|</span><span><a href="#">author</a></span></div> ' +
                        '<div class="post-title"><a href="' + post + '">' + post + '</a></div>' +
                        '<div class="post-tags">Tags: <span><a href="#">JavaScript</a></span><span><a href="#">HTML5</a></span><span><a href="#">NOTE</a></span></div>' +
                        '<div class="tip-footer"><span>100 views</span><span>10 comments</span></div> '



                    tip = $('<div class="tip activity-tip">'+ activityStatus +'</div>');
                    tringle = $('<span class="tringle"/>');
                    day = $('<div class="day activity-day" style="background-color: ' + backgroundColor + ';" />');
        ...
        daysOfWeek.append($('<div class="dayOfWeek"></div>'));
