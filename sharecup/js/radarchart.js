function drawRadarChart(data){
	var radarSvgCheck=d3.select("svg");
	if(radarSvgCheck.id!=="radarchartsvg"){
...
//Legend titles
var LegendOptions = ['发病率最高的10种肿瘤','发病率最高的5种肿瘤'];
...
var d = [
		  [
			{axis:"食管癌",value:3628},
			{axis:"胃癌",value:1681},
			{axis:"支气管和肺癌",value:1095},
			{axis:"肝和肝内胆管癌",value:681},
			{axis:"乳房癌",value:186},
			{axis:"直肠癌",value:153},
			{axis:"血液癌",value:132},
			{axis:"结肠癌",value:113},
...
RadarChart.draw("#svgArea", d, mycfg);

	  var radarLegend=d3.select("div#currOption")
						.selectAll("div")
	...
	d3.select("svg").append("text")
	  .text("2006-2011发病率最高的10种肿瘤")
	  .attr("id","radarcharttitle")
